...
export function ServiceCard({ service, compact = false }: ServiceCardProps) {
  ...
  if (compact) {
    return (
      <a
        ...
        className="group flex flex-col items-center gap-3 p-5 glass-card shimmer rounded-2xl text-center"
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="group flex items-center gap-5 p-5 glass-card shimmer rounded-2xl"
    >
      {/* Icon */}
      <div
